...
const nomor_hp_yang_ngirim = "Ary"
const nama_yang_ngirim = "pacarmu Ary"

// nama 
const nama = "Indriku sayang"

// yang ini biarin aja
let n = 0
const link_wa = `http://t.me/kakek_guru/ send?text=Aku udah terima ucapannya, makasih ya sayang`
nm.textContent = nama
...
const kata = [
  ...
  `Jangan sampai kecapaean, jangan sampai sakit, semoga jadi berkat ya sayang`,
  `Jangan lupa di makan kue nya, walaupun virtual hehe`,
  `Love You ${nama} cantik`
]
